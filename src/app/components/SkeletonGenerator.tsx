...
const SkeletonGenerator = () => {
  ...
  return (
    <main className="min-h-screen px-2 grid grid-rows-[auto_1fr] pb-20 md:pb-0 sm:px-8 md:px-12 lg:px-20 gap-8 sm:gap-12 lg:gap-16 font-[family-name:var(--font-geist-sans)]">
      <Info />
